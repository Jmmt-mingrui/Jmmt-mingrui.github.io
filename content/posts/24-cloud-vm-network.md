...
![image.png](./24-cloud-vm-network/image.png)
...
![image.png](./24-cloud-vm-network/image 1.png)
...
![image.png](./24-cloud-vm-network/image 2.png)
...
- **桥接(Bridge)**
    ...
    ![image.png](./24-cloud-vm-network/image 3.png)
    
    - 桥接模式下，虚拟机和笔记本电脑的都在同一IP网段下
        
        ![image.png](./24-cloud-vm-network/image 4.png)
        
    - 在数据中心中，采取类似的技术，都是Linux系统，每台机器都创建网桥和br0，虚拟机的网卡都连接到br0上，物理网卡也连接到br0上，所有的br0都通过物理网卡来连接到物理交换机上
        
        ![image.png](./24-cloud-vm-network/image 5.png)
        
        **网络打平， 虚拟机和物理网络会有同样的IP网段** 
        
        ![image.png](./24-cloud-vm-network/image 6.png)
...
- 另外一种方式为NAT（网络层），在这种情况下，登录到虚拟机里面查看IP地址，会发现虚拟机的网络是虚拟机的，物理机的网络是物理机的，两个不相同。虚拟机要想访问物理机的时候，需要将地址NAT成为物理机的地址。
    ...
    ![image.png](./24-cloud-vm-network/image 7.png)
    ...
    - 数据中心中也是类似的方式，
        ...
        ![image.png](./24-cloud-vm-network/image 8.png)
    ...
    - 如果是你自己登录到物理机上做个简单配置，你可以简化一下。
        ...
        ![image.png](./24-cloud-vm-network/image 9.png)
...
![image.png](./24-cloud-vm-network/image 10.png)
